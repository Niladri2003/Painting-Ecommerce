...
const OverlaySection = () => {
    ...
    return (
        <div className="flex flex-col md:flex-row w-full items-center justify-center my-10 px-4 md:px-10 lg:px-20">
            ...
            >
                <motion.img
                    src={"https://images.unsplash.com/photo-1579783928621-7a13d66a62d1?q=80&w=1980&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"}
                    alt="Large"
