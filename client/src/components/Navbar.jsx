                ...
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:flex lg:flex">
                        <div className="ml-10 flex items-baseline space-x-4">
                            ...
                            <Link to="/contact" onClick={handleNavItemClick} className={`${isScrolled ? 'text-white' : 'text-black'} hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium flex items-center`}>
