...
import { FaShoppingCart, FaBars, FaTimes } from 'react-icons/fa';
import { AiOutlineShoppingCart } from "react-icons/ai";
import { Avatar, useToast } from '@chakra-ui/react'; // Import useToast from Chakra UI
import defaultAvatar from '../assets/avatar/defaultAvatar.jpg'; // A default avatar image
...
const Navbar = () => {
    ...
    const handleLogout = () => {
        dispatch(logout());
        dispatch(resetCart()) // Dispatch logout action
        toast({
                            ...
                            <div className="hidden md:flex items-center justify-center gap-x-4">
                                {token ? (
                                    <div className="relative" ref={dropdownRef}>
                                        ...
                                        {isDropdownOpen && (
                                            <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg z-10">
                                                <Link to="/orders" className="flex items-center px-4 py-2 text-gray-800 hover:rounded-md hover:bg-gray-200">
                                                    
                                                    My Orders
                                                    <LiaTruckLoadingSolid className="ml-2" />
                                                </Link>
                                                <Link to="/account" className="flex items-center px-4 py-2 text-gray-800 hover:bg-gray-200">
                                                    
                                                    My Account
                                                    <RiAccountCircleFill className="ml-2" />
                                                </Link>
                                                <button onClick={handleLogout} className="flex items-center w-full text-left px-4 py-2 text-red-600 hover:rounded-md hover:bg-gray-200">
                                                    Logout
                ...
                <div className="flex flex-col mt-6 space-y-4 px-4">
                    {token && (
                        <div className="mb-4 flex justify-center relative">
                            ...
                            {isMobileDropdownOpen && (
                                <div className="absolute right-4 mt-2 w-48 bg-white rounded-md shadow-lg z-10">
                                    <Link to="/orders" className="flex items-center px-4 py-2 text-gray-800 hover:bg-gray-200">
                                        <LiaTruckLoadingSolid className="mr-2" />
                                        My Orders
                                    </Link>
                                    <Link to="/account" className="flex items-center px-4 py-2 text-gray-800 hover:bg-gray-200">
                                        <RiAccountCircleFill className="mr-2" />
                                        My Account
                                    </Link>
                                    <button onClick={handleLogout} className="flex items-center w-full text-left px-4 py-2 text-gray-800 hover:bg-gray-200">
