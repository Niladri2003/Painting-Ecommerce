        ...
        <footer className="bg-gray-800 text-white py-8 px-2">
            <div className="container mx-auto flex flex-wrap justify-between px-4">
                ...
                <div className="w-full md:w-1/6 mb-4 md:mb-0">
                    ...
                    <ul>
                        <li><Link to="/" onClick={scrollTop} className="text-gray-400 hover:text-white">Home</Link></li>
                        <li><Link to="/shop" onClick={scrollTop} className="text-gray-400 hover:text-white">Shop</Link></li>
                        <li><Link to="/about" onClick={scrollTop} className="text-gray-400 hover:text-white">About</Link></li>
                        <li><Link to="/contact-us" onClick={scrollTop} className="text-gray-400 hover:text-white">Contact</Link></li>
                    </ul>
                </div>
                <div className="w-full md:w-1/6 mb-4 md:mb-0">
