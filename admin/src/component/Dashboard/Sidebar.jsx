...
import React, { useRef, useEffect } from "react";
import { NavLink, useLocation, matchPath } from "react-router-dom"; // Add matchPath here
import { Link, Text, useColorModeValue } from "@chakra-ui/react";
import { dashboardLinks } from "../../utils/sidebarLink.js";
...
const Sidebar = ({ isSidebarOpen, toggleSidebar, setIsSidebarOpen }) => {
    ...
    const matchRoute = (route) => matchPath(route, location.pathname); // Simplified matchPath usage
